...
interface TaskProps {
  ...
  onComplete: (id: number) => void; // Function to complete a task
  onRemove: (id: number) => void; // Function to remove a task
}

export default function Task({ task, done, onComplete, onRemove }: TaskProps) {
